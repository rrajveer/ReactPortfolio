        ...
        <AboutWrapper>
            ...
            <div className="about-us">
                <div className="abt-img"data-aos="flip-up" data-aos-delay="300" >
                    ...
                    alt="img" style={{height:"200px", width:"auto",marginTop:"2px",marginLeft:"10rem"}}/>
                </div>
                <div className="abt-desc" data-aos="flip-up" data-aos-delay="600" style={{marginTop:"1.2rem",fontSize:"0.9rem",color:"white",opacity:"0.8"}}>
                    <p >
                    <strong>"</strong>I am currently pursuing a Post Graduate Diploma in Web Programming and Technologies and 
                   I have done a master’s in computer science to acquire the necessary knowledge for a career 
                   in these fields.<strong>"</strong> 
                    </p>

                    <p style={{fontFamily: "Helvetica, Arial, sans-serif",marginTop:"1.5rem",fontSize:"0.9rem",color:"white",opacity:"1"}}> <strong>"</strong>
                      I am a dedicated Web Developer with more than one year hands-on experience in the design and development of websites using various technologies like <span className="paraWord">REACT,HTML,CSS and MySQL</span>. 
